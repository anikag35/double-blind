#!/usr/bin/env bash
# Regenerates worker/blind_pb2.py, worker/blind_pb2_grpc.py, and worker/blind_pb2.pyi from proto/blind.proto.
...
echo "Generated worker/blind_pb2.py, worker/blind_pb2.pyi, and worker/blind_pb2_grpc.py"
